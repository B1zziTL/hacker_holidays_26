...
1. "track down an account nobody was supposed to find" -> user-account mentioned in the given screenshot: "lambobytelotushotel@gmail.com"
2. conversation hints at a platform which allows linking social media (eg. Linktree), starting with "G" -> `Gravatar`
